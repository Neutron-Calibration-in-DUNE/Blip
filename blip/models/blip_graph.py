...
#             raise BlipError('embedding section not in BlipGraph config!')
#         if "reduction" not in self.config.keys():
#             raise BlipError('reduction section not in BlipGraph config!')
...
#             else:
#                 raise BlipError(f'specified embedding type {embedding_config[embedding]["embedding_type"]} not allowed!')
...
#             raise BlipError('mlp_output_layers not specified in classification section of config!')
