...
def get_diffusion_frechet_function(G,t,mu = None):
    ...
    if mu is None: mu = ot.unif(len(G))
...
class MergeTreeModule(nn.Module):    
    ...
    def __init__(self,
        ...
        super(MergeTreeModule, self).__init__(self.name, config, mode, meta)
        self.T              = tree
    ...
    def parse_config(self): self.logger.error(f'"parse_config" not implemented in Module!')

    def run_module(self): self.logger.error(f'"run_module" not implemented in Module!')
